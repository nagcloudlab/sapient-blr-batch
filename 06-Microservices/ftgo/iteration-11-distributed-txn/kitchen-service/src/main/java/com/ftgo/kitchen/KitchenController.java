...
public class KitchenController {
    ...
    /**
     * Cancel a ticket by order ID. Called by saga orchestrator during compensation.
     * PUT /api/kitchen/tickets/order/{orderId}/cancel
     */
    @PutMapping("/order/{orderId}/cancel")
    public KitchenTicket cancelTicketByOrderId(@PathVariable Long orderId) {
        return kitchenService.cancelTicketByOrderId(orderId);
    }
}
