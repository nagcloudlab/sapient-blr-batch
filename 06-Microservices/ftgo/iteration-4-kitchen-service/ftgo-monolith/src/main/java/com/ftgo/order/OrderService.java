...
public class OrderService {
    ...
    // ========================================================================
    // ITERATION 4: Kitchen is now an external service with Circuit Breaker!
    //
    // Extracted so far:
    //   - Restaurant → REST (iteration 1)
    //   - Notification → Kafka async (iteration 2)
    //   - Accounting → REST + Circuit Breaker (iteration 3)
    //   - Kitchen → REST + Kafka bidirectional (iteration 4) ← NEW
    //
    // Kitchen-service is the first BIDIRECTIONAL extraction:
    //   - Monolith → Kitchen: REST (create ticket, accept, prepare, ready)
    //   - Kitchen → Monolith: Kafka (status change events update Order)
    //
    // Remaining module: Delivery (still local).
    // ========================================================================
    @Transactional
