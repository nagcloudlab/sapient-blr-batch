...
public class OrderService {
    ...
    // ========================================================================
    // ITERATION 2 CHANGE: Notification is now ASYNCHRONOUS via Kafka!
    //
    // Before: notificationService.sendOrderConfirmation() — SYNCHRONOUS
    //   User waited for SMS to "send" before seeing their order confirmation.
    //
    // After: orderEventPublisher.publishOrderCreated() — ASYNCHRONOUS
    //   We publish an event to Kafka and return immediately.
    //   notification-service picks it up in the background.
    //
    // Remaining modules (Kitchen, Delivery, Accounting) are still synchronous.
    // We'll need the Saga pattern for those (coming in Iteration 6).
    // ========================================================================
    @Transactional
