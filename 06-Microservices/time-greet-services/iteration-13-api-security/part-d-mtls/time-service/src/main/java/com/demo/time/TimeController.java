...
public class TimeController {
    ...
    @GetMapping("/time")
    public Map<String, String> time(HttpServletRequest request) throws UnknownHostException {
    ...
    public Map<String, Object> timeWithGreeting(HttpServletRequest request) throws UnknownHostException {
