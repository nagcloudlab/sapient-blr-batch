...
public class TimeController {
    ...
    @Value("${greeting.service.url:http://localhost:9001}")
    ...
    @GetMapping("/time")
    public Map<String, String> time(@AuthenticationPrincipal Jwt jwt) throws UnknownHostException {
    ...
    public Map<String, Object> timeWithGreeting(@AuthenticationPrincipal Jwt jwt) throws UnknownHostException {
