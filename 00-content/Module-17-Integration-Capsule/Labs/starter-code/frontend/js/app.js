/**
 * FoodExpress - Order Page Frontend
 *
...
// BUG 1: Wrong element ID - should be 'menu-container' not 'menu-list'
// The HTML has <div id="menu-container"> but we're binding to 'menu-list'
...
// BUG 2: Price display concatenates strings instead of adding numbers
// Using string concatenation (+) with a string prefix causes all subsequent
// additions to be string concatenation, not arithmetic
function calculateTotal() {
    let total = "0";  // BUG: Should be 0 (number), not "0" (string)
    for (let i = 0; i < cart.length; i++) {
        total = total + cart[i].price * cart[i].quantity;
        // With total="0", this produces "0350" then "0350280" etc.
    }
    return total;
}
