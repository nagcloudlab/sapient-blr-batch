# Lab 5.3: Bridge-to-Bridge Network Communication
...
Lab 5.3  Bridge-to-Bridge Routing   ← you are here
Lab 5.4  Network Troubleshooting    (next)
...
- Completed Lab 5.2 (Networking Under the Hood) — you will use concepts like veth pairs, bridges, and routing tables from that lab
...
Continue to **Lab 5.4: Network Troubleshooting & Debugging** to learn how to diagnose and fix Docker networking issues using tcpdump, DNS debugging, and structured failure scenarios.
