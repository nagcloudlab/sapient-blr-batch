...
public class UpiTransferService {
    ...
    public UpiTransferService(AccountRepository accountRepository) {
        ...
        logger.info("UpiTransferService component is initialized with AccountRepository: {}", accountRepository.getClass().getSimpleName());
    }
    ...
    public void transfer(double amount, String fromAccountNumber, String toAccountNumber) {
        ...
        //AccountRepository accountRepository = AccountRepositoryFactory.createAccountRepository("SQL"); // use factory to create instance
