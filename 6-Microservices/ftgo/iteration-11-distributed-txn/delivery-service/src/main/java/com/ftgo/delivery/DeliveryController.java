...
public class DeliveryController {
    ...
    /**
     * Cancel a delivery by order ID. Called by saga orchestrator during compensation.
     * PUT /api/deliveries/order/{orderId}/cancel
     */
    @PutMapping("/order/{orderId}/cancel")
    public Delivery cancelDeliveryByOrderId(@PathVariable Long orderId) {
        return deliveryService.cancelDeliveryByOrderId(orderId);
    }
