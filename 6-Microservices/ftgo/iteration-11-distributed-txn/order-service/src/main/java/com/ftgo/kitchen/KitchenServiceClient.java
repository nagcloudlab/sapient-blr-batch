...
/**
 * Anti-Corruption Layer + Circuit Breaker for the Kitchen Service.
 *
...
public class KitchenServiceClient {
    ...
    public KitchenTicketResponse createTicket(Long orderId, Long restaurantId, String items) {
        ...
        return restTemplate.postForObject(
                "http://kitchen-service/api/kitchen/tickets",
                request,
    ...
    public KitchenTicketResponse acceptTicket(Long ticketId) {
        ...
        return restTemplate.exchange(
                "http://kitchen-service/api/kitchen/tickets/{id}/accept",
                HttpMethod.PUT,
                null,
                KitchenTicketResponse.class,
                ticketId
    ...
    public KitchenTicketResponse startPreparation(Long ticketId) {
        ...
        return restTemplate.exchange(
                "http://kitchen-service/api/kitchen/tickets/{id}/preparing",
                HttpMethod.PUT,
                null,
                KitchenTicketResponse.class,
                ticketId
    ...
    public KitchenTicketResponse markReady(Long ticketId) {
        ...
        return restTemplate.exchange(
                "http://kitchen-service/api/kitchen/tickets/{id}/ready",
                HttpMethod.PUT,
                null,
                KitchenTicketResponse.class,
                ticketId
    ...
    public List<KitchenTicketResponse> getTicketsByRestaurantId(Long restaurantId) {
        ...
        return restTemplate.exchange(
                "http://kitchen-service/api/kitchen/tickets?restaurantId={restaurantId}",
                HttpMethod.GET,
                null,
    ...
    @CircuitBreaker(name = "kitchenService", fallbackMethod = "cancelTicketFallback")
    public void cancelTicket(Long orderId) {
        log.info(">>> Calling kitchen-service to cancel ticket for order #{}", orderId);
        restTemplate.put(
                "http://kitchen-service/api/kitchen/tickets/order/{orderId}/cancel",
                null,
                orderId);
    }

    public void cancelTicketFallback(Long orderId, Throwable t) {
        log.error(">>> CIRCUIT BREAKER: Cannot cancel ticket for order #{}. Reason: {}", orderId, t.getMessage());
        throw new RuntimeException("Kitchen service unavailable — cannot cancel ticket for order: " + orderId);
    }
