...
public class TimeController {
    ...
    @GetMapping("/time")
    public Map<String, String> time(Authentication auth) throws UnknownHostException {
    ...
    public Map<String, Object> timeWithGreeting(Authentication auth) throws UnknownHostException {
