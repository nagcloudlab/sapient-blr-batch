...
/**
 * FoodExpress Order Service (FIXED)
...
public class OrderService {
     ...
     * FIX: Order confirmation now shows the discounted price.
     */
    public OrderConfirmation createOrder(Customer customer, List<OrderItem> items,
        ...
        // FIX: Confirmation now uses discountedTotal instead of originalTotal
        // Customer sees the correct post-discount price in their confirmation
        OrderConfirmation confirmation = new OrderConfirmation(
            orderId,
            customer.getName(),
            items,
            discountedTotal,  // FIX: Was originalTotal, now discountedTotal
